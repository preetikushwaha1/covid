...
?>  
  ...
  <!---preeti .js----------------------------------------------------------------->
    ...
    <script type="text/javascript" src="<?php echo base_url('assets1/preeti_js/preeti_jquery.js');?>?version=3.8">
         ...
         success:function(data)
          {
            ...
            $('#search_text').keyup( function()
            {
              ...
              var expession=new RegExp(searchField,"i");
             // console.log(expession);
             var sno=1;
              $.each(data.Countries,function(key,value)
               {
                //console.log(value.Country);
                  if(value.Country.search(expession)!=-1)
                  {
                    $('#country_wise_data').append("<tr>"+
                                        "<td>"+ sno +"</td>" +
                                         "<td>"+ value.Country+"</td>" +
         ...
         success:function(data)
          {
            ...
            {
              $('#india_state_wise_data').html('');
              var searchField=$('#search_text1').val();
              var expession=new RegExp(searchField,"i");
             console.log(expession);
             var sno=1;
              $.each(data.statewise,function(key,value)
               {
                console.log(value.statewise);
                  if(value.state.search(expession)!=-1)
                  {
                             $("#india_state_wise_data").append("<tr >"+
                                        "<td>"+ sno+"</td>" +
                                         "<td>"+ value.state+"</td>" +
